...
def define_args():
    ...
    tf.app.flags.DEFINE_string('mode', 'test', """mode, train_feature, train_trans, train, test""")
    ...
    tf.app.flags.DEFINE_string('data_dir', '../../data/SHREC2013/data', """data directory""")
    tf.app.flags.DEFINE_string('view_dir', 'VIEW_GRAY', """VIEW, VIEW_BLACK, VIEW_GRAY, VIEW_GRAY_BLACK""")
    ...
    tf.app.flags.DEFINE_float('margin', 0.2, """margin for triplet loss""")

    tf.app.flags.DEFINE_integer('max_epoch', 40, """maximum number of epoch""")
    tf.app.flags.DEFINE_float('lr', 1e-3, """initial learning rate""")
    tf.app.flags.DEFINE_integer('decay_steps', 100000, """decay steps for exponentially decaying learning rate""")
