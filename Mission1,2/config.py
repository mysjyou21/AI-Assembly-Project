...
def parse_args(description='Robot'):
    ...
    parser.add_argument('--ocr_modelpath', default=os.path.join('./function', 'OCR', 'weight'))
...
def init_args(description='Robot'):
    ...
    opt.circlepath = os.path.join(opt.intermediate_results_path, 'circle')
    opt.rectanglepath = os.path.join(opt.intermediate_results_path, 'rectangle')
    opt.actionpath = os.path.join(opt.intermediate_results_path, 'action')
    opt.serialpath = os.path.join(opt.intermediate_results_path, 'serial')
    ...
    opt.multpath = os.path.join(opt.intermediate_results_path, 'mult')
