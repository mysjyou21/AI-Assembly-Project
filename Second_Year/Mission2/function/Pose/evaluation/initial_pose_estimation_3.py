...
from ..models.correspondence_block_model_3 import CorrespondenceBlockModel
...
class InitialPoseEstimation():
    def __init__(self, args):
        ...
        with args.graph_pose.as_default():
            ...
            print('POSE MODEL : Loading saved model from', self.checkpoint_path + '/correspondence_block_3.pt')
            checkpoint = torch.load(self.checkpoint_path + '/correspondence_block_3.pt', map_location='cuda:0')
    ...
    def test(self, args, step_num):
        ...
        with torch.no_grad():
            ...
            EDGE = edgemask_pred.astype(np.uint8)
