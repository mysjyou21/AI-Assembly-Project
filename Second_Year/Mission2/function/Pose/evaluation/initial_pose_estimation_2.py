...
from ..models.correspondence_block_model_2 import CorrespondenceBlockModel
...
class InitialPoseEstimation():
    def __init__(self, args):
        ...
        with args.graph_pose.as_default():
            ...
            print('POSE MODEL : Loading saved model from', self.checkpoint_path + '/correspondence_block_2.pt')
            checkpoint = torch.load(self.checkpoint_path + '/correspondence_block_2.pt', map_location='cuda:0')
