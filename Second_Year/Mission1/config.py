...
def parse_args(description='Robot'):
    ...
    parser.add_argument('--save_part_hole', default=True)
...
def init_args(description='Robot'):
    ...
    opt.cadinfo_path = os.path.join(opt.input_path, opt.assembly_name, 'cad_info2')
    ...
    opt.save_part_hole = string2bool(opt.save_part_hole)
