...
def OCR_serial(session, img_pl, logit_tf, assembly_name, serial_path, ocr_model_path, N_I, serial_loc):
    print('hihihihi')
    print('hihihihi')
    print('hihihihi')
    print('hihihihi')
    ...
    image_paths = sorted(glob.glob(os.path.join(serial_path, '*.png')))
    img_test = []
...
def OCR_mult(session, img_pl, logit_tf, assembly_name, multpath, ocr_model_path, OCR_serial_result, OCR_mult_intermidiate_result):
