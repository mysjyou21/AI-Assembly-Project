...
class Assembly():
    ...
    def hole_detector(self, step_num, step_parts_id, step_parts_pose):
        """ Detect hole in step_num-image, with given detection bounding boxes and poses
            step_num: step number, int :: 1
            step_parts_id: parts id, list :: ['part3', 'part2']
            step_parts_pose: parts_pose, list, with step_parts_id-order :: [17, 17]
            hole_info: used hole ids, list, with step_parts_id-order :: [['hole_7', 'hole_8'], ['hole_7', 'hole_8']]
            connectivity: indicate 'whether detected parts (in step_num) are connected' , '': not connected, 'partA#partB': connected
            """
    ...
    def retrieve_part(self, step_num, list_added_obj, list_added_stl):
        ...
        Args:
            ...
            list_added_obj: (list) (str) cad filenames

                cad filenames with .obj extension that where added at this step. ex) 'part1.obj'

            list_added_stl: (list) (str) cad filenames

                cad filenames with .STL extension that where added at this step. ex) 'part1.STL'
