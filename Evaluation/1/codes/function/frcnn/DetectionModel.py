...
class DetectionModel():
    ...
    def __init__(self, cut_names, det_config_name, graph_detect, sess_detect):
    ...
    def test(self, cut_img, opt, cut_number):
        ...
        for key in bboxes:
            ...
            for jk in range(new_boxes.shape[0]):
                ...
                cv2.rectangle(img, (real_x1, real_y1), (real_x2, real_y2),
                              (int(self.class_to_color[key][0]), int(self.class_to_color[key][1]), int(self.class_to_color[key][2])),
                              2)
        ...
        cv2.imwrite(os.path.join(opt.detection_img_path, self.cut_names[cut_number]), img)
