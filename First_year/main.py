...
if __name__ == '__main__':
    ...
    # operations
    """
    circle : find circle, make groups.
        group index starts from 1
    mult : find mult, put mult into group
    rectangle : find rect, exclude if mult is in rect. 
        grouping not implemented for multiple rect bubbles with mult
    serial : remove rect region
    """
