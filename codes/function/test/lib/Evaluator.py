...
class Evaluator:
    def GetPascalVOCMetrics(self,
        ...
        for c in classes:
            ...
            dect_indices = [detections.index(d) for d in dects]
            ...
            for j, tp in enumerate(TP):
                mark = 'TP' if tp else 'FP'
                detections[dect_indices[j]].append(mark)
            rec = acc_TP / npos
    ...
    def PlotPrecisionRecallCurve(self,
        ...
        Returns:
            ...
            dict['total FP']: total number of False Negative detections;
        """
        results, for_draw_bbox = self.GetPascalVOCMetrics(boundingBoxes, IOUThreshold, method)
        result = None
